...
knitr::kable(party_incumbent_promote, col.names = c("Party", "Incumbency Status", "Promote Proportion"), digits = 3)
...
fb_ads <-  c(fb_ads, impressions_millions)
...
impressions_millions <- fb_ads |>
  ...
  fct_reorder() |>
  ggplot(mapping = aes(x = impressions_millions, y = cand_name_last)) +
  geom_histogram(stat = "identity", aes(fill = party), na.rm = TRUE) 
